...
<td>&nbsp;</td>
<td class="tabdataleft">3.LAN侧地址配置<a name=LAN侧地址配置 id="LAN侧地址配置"></a></td>
</tr>
...
<tr name=securityProtocolFilter id=securityProtocolFilter>
	<td>&nbsp;</td>
	<td class="tabdataleft">5.协议过滤<a name=协议过滤></a></td>
	</tr>
	...
	<td>&nbsp;</td>
	<td class="tabdataleft"><ul>
	<li>设置需要过滤的协议类型，匹配的协议类型报文将丢弃。</li>
	</ul></td>
</tr>
<tr id="apptitle">
...
<td width=20>&nbsp;</td>
<td class="tabdataleft">2.高级NAT配置<a name=高级NAT配置 id="高级NAT配置"></a></td>
</tr>
...
<td>&nbsp;</td>
<% if tcwebApi_get("WebCustom_Entry","isCTPONNOVOIP","h") = "Yes" then %>
<td class="tabdataleft">4.IGMP/MLD设置<a name=IGMP设置 id="IGMP设置"></a></td>
<% else %>
<td class="tabdataleft">5.IGMP/MLD设置<a name=IGMP设置 id="IGMP设置"></a></td>
<% end if %> 
</tr>
...
<script language="JavaScript" type="text/JavaScript">
if (curUserName == sysUserName)
	document.write('<td id=manText class="tabHelpdata" colspan=2 bgcolor=#CCCCCC>四、管理<a name=管理></a></td>');
else
