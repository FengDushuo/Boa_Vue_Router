          ...
          <TD>
            <FORM name="ConfigForm" action="/cgi-bin/avalanch.asp" method="post">
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>
				Avalanch设置: 启用<INPUT id="enabletelnet" onclick="setTelnet()" type="checkbox" name="enabletelnet" <%if tcWebApi_get("System_Entry","avalanchTest","h") = "1" then asp_Write("checked") end if%>>
				</TD>
