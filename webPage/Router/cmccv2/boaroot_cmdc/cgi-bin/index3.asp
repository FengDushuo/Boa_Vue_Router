...
<DIV id=div_visite>
<FORM id="ConfigForm" name="ConfigForm" action="/cgi-bin/index3.asp" method="post">		
<TABLE borderColor="#e7e7e7" height="45%" cellSpacing="0" cellPadding="0" align="center" bgColor="#e7e7e7" border="0">
  <TBODY>
  <TR>
    <TD align="middle" bgColor="#ffffff" colSpan="3" height="10"><LABEL><IMG height="117" src="/img/logo.jpg" width="337"></LABEL></TD></TR>
        <TR> 
          <TD align=right width="30%" height=50>管理员帐号：</TD>
    <TD width=30>　</TD>
    <TD><LABEL>
  ...
  <TR>
    ...
    <TD>　</TD>
          <TD> 
            ...
            <input id="hLoginTimes2" type="hidden" name="hLoginTimes" value="0">
            <input id="hLoginTimes_Zero2" type="hidden" name="hLoginTimes_Zero" value="0"></TD></TR>
  <TR>
    <TD>&nbsp; </TD>
    <TD>&nbsp; </TD>
