...
<style>
    ...
    input.input-large, input.input-large.secondary, button.input-large, button.input-large.secondary {
        width: 200px;
        min-width: 200px;
    }
    ...
    .cbi-section-table tr td {
        ...
        border-bottom: 1px solid rgba(202, 208, 209, 0.5);
    }
</style>
...
<BODY style="TEXT-ALIGN: center" vLink=#000000 aLink=#000000 link=#000000 leftMargin=0 topMargin=0
    ...
    <div class="header">
        ...
        <div class="in_welcom" >
            ...
            <input id="Selected_Menu" type="hidden" value="应用->MESH拓扑图" name="Selected_Menu">
        </div>
    </div>
                    ...
                    <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0 class="tblMain">
                        <TBODY>
                            <TR>
                                <TD id="MenuArea_L2">
                                    <ul class="TRD">
                                        <li name="IGMPSet" id="MESH拓扑图" class="TSD">拓扑图</li>
                                    </ul>
                                </TD>
                                <SCRIPT language=javascript>
                                                        ...
                                                        <TR>
                                                            <TD>
                                                                <div id="maincontent" class="container">
                                                                    ...
                                                                    <p class="form-text">检索 EasyMesh 运行时的拓扑信息。</p>
                                                                    </div>
                                                                    ...
                                                                    <button id="toggle_all_1905_dev_info_btn" class="input-large" onclick="toggle_disp_dev_table(this)" style="margin-left: 24px;" disabled="disabled">显示组网信息详细信息</button>
                                                                    ...
                                                                    <script type="text/javascript">
                                                                        ...
                                                                        {
                                                                            location.href = '/cgi-bin/wifi_multi_topo.asp';
                                                                        }
