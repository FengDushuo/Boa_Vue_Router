  ...
  <TR>
	...
	<SCRIPT language=JavaScript type=text/javascript>
		...
		function QoSChangeMode()
		{
			...
			GetTempleteString();
			//document.ConfigForm.submit();   need use jquery for hook
			$("form[name='ConfigForm']").submit();
		}
...
function writeLaninfoTable()
{
		...
		loc += '<TR align="middle">';
		loc += '<TD class="table_title" align="center">LAN/SSID</TD>';
		loc += '<TD class="table_title" align="center">限速(单位：512Kbps)</TD>';
		loc+= '<TD class="table_title" align="center">修改</TD>';
		loc += '<TD class="table_title" align="center">删除</TD>';
		loc+= '</TR>';
		if(interfacelimitup != '')
		{
				for(k=0; k < lanx.length; k++)
				{
					...
					loc+= '<TD class="w-92"><INPUT id="Del_'+ k +'" onclick="btnDelApp(this.id)" class="BtnDel" type=button value=删除 name=DelApp></TD>'
					loc += '</TR>';
				}
		}
		loc += '</TABLE >';
		...
		loc += '<TR>';
		loc += '<TD class="w-92"><INPUT id="AddApp" onclick="btnAddApp()" class="BtnAdd" type=button value=添加 name=AddApp></TD>';
		loc+= '</TR>';
		loc += '</TABLE >';
...
function writevlantagTable()
{
		...
		loc = '<TABLE class="tblList" border=1>';
		loc += '<TR align="middle">';
		loc += '<TD class="table_title" align="center">VLAN</TD>';
		loc += '<TD class="table_title" align="center">限速(单位：512Kbps)</TD>';
		loc+= '<TD class="table_title" align="center">修改</TD>';
		loc += '<TD class="table_title" align="center">删除</TD>';
		loc+= '</TR>';
		if(vlantaglimitup != '')
		{
				for(k=0; k < vlanx.length; k++)
				{
					...
					loc+= '<TD class="w-92"><INPUT id="Del_'+ k +'" onclick="btnDelVlan(this.id)" type=button value=删除 name=DelVlan class="BtnDel" ></TD>'
					loc += '</TR>';
				}
		...
		loc += '<TABLE  width=100% border=0>';
		loc += '<TR>';
		loc += '<TD class="w-92"><INPUT id="AddVlan" onclick="btnAddVlan()" type=button value=添加 name=AddVlan class="BtnAdd" ></TD>';
		loc+= '</TR>';
		loc += '</TABLE >';
...
function writeipTable()
{
		...
		loc = '<TABLE class="tblList" border=1>';
		loc += '<TR align="middle">';
		loc += '<TD class="table_title" align="center">IP范围</TD>';
		loc += '<TD class="table_title" align="center">限速(单位：512Kbps)</TD>';
		loc+= '<TD class="table_title" align="center">修改</TD>';
		loc += '<TD class="table_title" align="center">删除</TD>';
		loc+= '</TR>';
		if(iplimitup != '')
		{
				for(k=0; k < ipx.length; k++)
				{
					...
					loc+= '<TD class="w-92"><INPUT id="Del_'+ k +'" onclick="btnDelIp(this.id)" type=button value=删除 name=DelIP class="BtnDel"></TD>'
					loc += '</TR>';
				}
		}
		loc += '</TABLE >';
		loc += '<TABLE  width=100% border=0>';
		loc += '<TR>';
		loc += '<TD class="w-92"><INPUT id="AddIp" onclick="btnAddIP()" type=button value=添加 name=AddIP class="BtnAdd" ></TD>';
		loc+= '</TR>';
		loc += '</TABLE >';
...
function writeLaninfodownTable()
{
		...
		if(interfacelimitdown != '')
		{
				for(k=0; k < lanx_down.length; k++)
				{
					...
					loc+= '<TD class="w-92"><INPUT id="Deldown_'+ k +'" onclick="btnDelApp_down(this.id)" type=button value=删除 name=DelApp class="BtnDel"></TD>'
					loc += '</TR>';
				}
		}
		loc += '</TABLE >';
		loc += '<TABLE  width=100% border=0>';
		loc += '<TR>';
		loc += '<TD class="w-92"><INPUT id="AddApp_down" onclick="btnAddApp_down()" type=button value=添加 name=AddApp_down class="BtnAdd"></TD>';
		loc+= '</TR>';
		loc += '</TABLE >';
...
function writevlantagdownTable()
{
		...
		if(vlantaglimitdown != '')
		{
				for(k=0; k < vlanx_down.length; k++)
				{
					...
					loc+= '<TD class="w-92"><INPUT id="Deldown_'+ k +'" onclick="btnDelVlan_down(this.id)" type=button value=删除 name=DelVlan_down class="BtnDel"></TD>'
					loc += '</TR>';
				}
		}
		loc += '</TABLE >';
		loc += '<TABLE  width=100% border=0>';
		loc += '<TR>';
		loc += '<TD class="w-92"><INPUT id="AddVlan_down" onclick="btnAddVlan_down()" type=button value=添加 name=AddVlan_down class="BtnAdd" ></TD>';
		loc+= '</TR>';
		loc += '</TABLE >';
...
function writeipdownTable()
{
		...
		if(iplimitdown != '')
		{
				for(k=0; k < ipx_down.length; k++)
				{
					...
					loc+= '<TD class="w-92"><INPUT id="Deldown_'+ k +'" onclick="btnDelIp_down(this.id)" type=button value=删除 name=DelIP_down class="BtnDel" ></TD>'
					loc += '</TR>';
				}
		}
		loc += '</TABLE >';
		loc += '<TABLE  width=100% border=0>';
		loc += '<TR>';
		loc += '<TD class="w-92"><INPUT id="AddIp_down" onclick="btnAddIP_down()" type=button value=添加 name=AddIP_down class="BtnAdd"></TD>';
		loc+= '</TR>';
		loc += '</TABLE >';
...
var cfg_menu_list  = new Array('上行QoS配置', '限速配置');
var cfg_cookie_name = 'net-qos-menu';
init_l_menu();
	</SCRIPT>
      ...
      <TABLE height="100%" cellSpacing=0 cellPadding=0 border=0 class="tblMain">
        ...
        <TR>
          <TD class="Item_T">
		  <ul class="TRD">
		      <li name="UPstreamQoSCnf" id="上行QoS配置">上行QoS配置</li>
		      <li name="LimitSpeedCnf" id="限速配置">限速配置</li>
		  </ul>
	   </TD>
	  <TD class='w-828'>
         ...
         <TR>
          ...
          <TD valign="top">
            <DIV  id="上行QoS配置_item" class='hide'>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                  ...
                  <TABLE width="100%" border=0>
                    ...
                    <TR>
                      <TD class='w-130'>
                                <B>规则模板：</B></TD>
                      <TD>
			  <select id=Mode onChange="QoSChangeMode()" size=1 name="Mode">
                          </select> 
			                        <SCRIPT language=JavaScript type=text/javascript>
															initQoSTemplate();
															</SCRIPT>
                    ...
                    <TR>
                      <TD ><B>启用QoS：</B></TD>
                      <TD ><INPUT id="Enable" onclick="QoSEnableChange()" type=checkbox value=0 name="Enable" <%if TCWebApi_get("QoS_Common", "Active","h") = "Yes" then asp_Write("checked") end if%>>
                  ...
                  <TABLE border=0>
                    <TBODY>
                    <TR>
                      <TD class='w-130'><B>上行带宽：</B></TD>
                      <TD>
                       <input id=Bandwidth maxlength=10 size=16 value="<%if tcWebApi_get("QoS_Common","UplinkBandwidth","h") <> "N/A" then tcWebApi_get("QoS_Common","UplinkBandwidth","s") else asp_Write("0") end if%>" name="Bandwidth">
                       (0,8192-1000000000)bps</TD>
                     </TR>
                    </TBODY>
                  </TABLE>
                  <TABLE width="100%" border=0 id="policy" name="policy">
                    <TBODY>
                    <TR>
                      <TD class='w-130'><B>调度策略：</B></TD>
                      <TD>
                           <INPUT id="Plan" onclick="PlanChange()" type=radio value="priority" name="Plan" <%if tcWebApi_get("QoS_Common","Discipline","h") = "PQ" then asp_Write("checked") end if%>>
                           PQ
                           &nbsp;
                           <INPUT id="Plan" onclick="PlanChange()" type=radio value="weight" name="Plan" <%if tcWebApi_get("QoS_Common","Discipline","h") = "WRR" then asp_Write("checked") end if%>>
                           WRR
                      </TD>
                    </TR>
                    </TBODY>
                  ...
                  <TABLE width="100%" border=0>
                    <TBODY>
                    <TR id=EnableForce>
                      <TD class='w-130'><B>使能强制带宽：</B></TD>
                      <TD ><INPUT id=EnableForceWeight type=checkbox value=0 name="EnableForceWeight" <%if tcWebApi_get("QoS_Common","EnableForceWeight","h") = "Yes" then asp_Write("checked") end if%>>
                                    <input type="hidden" name="EnableForceFlag" value="No"></TD>
                    </TR>
                    <TR>
                      <TD class='w-130' ><B>启用DSCP/TC标志：</B></TD>
                      <TD ><INPUT id=EnableDSCPMark type=checkbox 
                    ...
                    <TR>
                      <TD class='w-130'><B>启用802.1p标志：</B></TD>
                      <TD ><SELECT id=Enable8021P size=1 name="Enable8021P"> 
                  ...
                  <TABLE width="100%" border=0>
                    ...
                    <TR>
                      ...
                      <TD>
                        <INPUT id=COMVlanCls onclick="VlanSubmit('/cgi-bin/qos-comvlan.asp')" type=button value=设置VLAN值 name=COMVlanCls>
                      </TD>
                      <% end if %>
                    </TR>
                  </TBODY>
               ...
               <DIV id=QueueEdit>
                  ...
                  <TABLE class="tblList" border=1>
                    ...
                    <TR>
                      ...
                      <TD align=middle><INPUT id=Q1Enable name=Q1Enable type=checkbox value="0" <%if tcWebApi_get("QoS_Common","QueueSW1","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q2</TD>
                      <TD align=middle>高</TD>
                      <TD align=middle><INPUT id=Q2Enable name=Q2Enable type=checkbox value=0 <%if tcWebApi_get("QoS_Common","QueueSW2","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q3</TD>
                      <TD align=middle>中</TD>
                      <TD align=middle><INPUT id=Q3Enable name=Q3Enable type=checkbox value=0 <%if tcWebApi_get("QoS_Common","QueueSW3","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q4</TD>
                      <TD align=middle>低</TD>
                      <TD align=middle><INPUT id=Q4Enable name=Q4Enable type=checkbox value=0 <%if tcWebApi_get("QoS_Common","QueueSW4","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                  </TBODY>
                  </TABLE></DIV>
                  <DIV id=WRREdit>
                  <TABLE class="tblList" border=1>
                    ...
                    <TR>
                      ...
                      <TD align=middle><INPUT id=Q5Enable type=checkbox value=0 <%if tcWebApi_get("QoS_Common","QueueSW1","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q2</TD>
                      ...
                      <TD align=middle><INPUT id=Q6Enable type=checkbox value=0 <%if tcWebApi_get("QoS_Common","QueueSW2","h") = "Yes" then asp_Write("checked") end if %>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q3</TD>
                      ...
                      <TD align=middle><INPUT id=Q7Enable type=checkbox value=0  <%if tcWebApi_get("QoS_Common","QueueSW3","h") = "Yes" then asp_Write("checked") end if %>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q4</TD>
                      ...
                      <TD align=middle><INPUT id=Q8Enable type=checkbox value=0 <%if tcWebApi_get("QoS_Common","QueueSW4","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    </TBODY>
                  </TABLE></DIV>
                  <DIV id=CAREdit>
                  <TABLE class="tblList" border=1>
                    ...
                    <TR>
                      ...
                      <TD align=middle><INPUT id=Q9Enable type=checkbox name="Q9Enable" <%if tcWebApi_get("QoS_Common","QueueSW1","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q2</TD>
                      ...
                      <TD align=middle><INPUT id=Q10Enable type=checkbox name="Q10Enable" <%if tcWebApi_get("QoS_Common","QueueSW2","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q3</TD>
                      ...
                      <TD align=middle><INPUT id=Q11Enable type=checkbox name="Q11Enable" <%if tcWebApi_get("QoS_Common","QueueSW3","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      <TD align=middle>Q4</TD>
                      ...
                      <TD align=middle><INPUT id=Q12Enable type=checkbox name="Q12Enable" <%if tcWebApi_get("QoS_Common","QueueSW4","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      ...
                      <TD align=middle><INPUT id=Q13Enable type=checkbox name="Q13Enable" <%if tcWebApi_get("QoS_Common","QueueSW5","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    <TR>
                      ...
                      <TD align=middle><INPUT id=Q14Enable type=checkbox name="Q14Enable" <%if tcWebApi_get("QoS_Common","QueueSW6","h") = "Yes" then asp_Write("checked") end if%>></TD>
                    </TR>
                    </TBODY>
                  </TABLE></DIV>
                </DIV>
                  ...
                  <TABLE width="100%" border=0>
                    <TBODY>
                    <TR>
                      <TD ><INPUT id=AddCls name=AddCls onclick="VlanSubmit('/cgi-bin/qos-clsedit.asp')" type=button value=进入分类编辑页面 ></TD>
                    </TR>
                    </TBODY>
                  </TABLE></DIV>
                <TD width=10>&nbsp;</TD>
              ...
              <TR>
                <TD colspan=2>
                <P align=center>
                 <IMG id=btnOK onclick="btnSave()" src="/img/ok.gif" border=0>
                 &nbsp;&nbsp;
                 <IMG id=btnCancel src="/img/cancel.gif" onclick="cancelClick()" border=0></P>
                </TD>
              </TR>
              	...
              	<TR>
              		...
              		<TD>
              			...
              			<div id="AppEdit" style="display:none">
											...
											<td class='w-130'>限速：</td>
											<td ><input name="vCuridxValue" type="text" id="vCuridxValue" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
										...
										<div id="AppAdd" style="display:none">
											...
											<tr>
											<td class='w-130'>限速：</td>
											<td ><input name="vCuridxValue1" type="text" id="vCuridxValue1" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
										...
										<div id="VlanEdit" style="display:none">
											...
											<tr>
											<td class='w-130'>限速：</td>
											<td ><input name="Vlan_CuridxValue" type="text" id="Vlan_CuridxValue" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
										...
										<div id="VlanAdd" style="display:none">
											...
											<tr>
											<td class='w-130'>限速：</td>
											<td ><input name="Vlan_CuridxValue1" type="text" id="Vlan_CuridxValue1" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
											...
											<table width="100%" border="0">  
											<tr>
											<td class='w-130'>IP范围：</td>
											<td class='w-50'><input name="Ip_Start" type="text" id="Ip_Start" value="0" size="15" maxlength="15">
											</td>
											<td class='w-5' style="text-align:center">-
											</td>
											<td class='w-50'><input name="Ip_End" type="text" id="Ip_End" value="0" size="15" maxlength="15">
											</td>
											</tr>
											</table>
											<table id = 'CarQueue' width="100%" border="0">  
											<tr>
											<td class='w-130'>限速：</td>
											<td ><input name="Ip_CuridxValue" type="text" id="Ip_CuridxValue" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
										...
										<div id="IpAdd" style="display:none">
											...
											<tr>
											<td class='w-130'>IP范围：</td>
											<td class='w-50'><input name="Ip_Start1" type="text" id="Ip_Start1" value="0" size="15" maxlength="15">
											</td>
											<td class='w-5' style="text-align:center">-</td>
											<td class='w-50'><input name="Ip_End1" type="text" id="Ip_End1" value="0" size="15" maxlength="15">
											</td>
											</td>
											</tr>
											</table>
											...
											<tr>
											<td class='w-130'>限速：</td>
											<td ><input name="Ip_CuridxValue1" type="text" id="Ip_CuridxValue1" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
                 ...
                 <TR>
              		...
              		<TD>
              			...
              			<div id="AppEdit_down" style="display:none">
											...
											<tr>
											<td class='w-130'>限速：</td>
											<td ><input name="vCuridxValue_down" type="text" id="vCuridxValue_down" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
										...
										<div id="AppAdd_down" style="display:none">
											...
											<table id = 'CarQueue' width="100%" border="0">  <tr>
											<td class='w-130'>限速：</td>
											<td ><input name="vCuridxValue1_down" type="text" id="vCuridxValue1_down" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
										...
										<div id="VlanEdit_down" style="display:none">
											...
											<table id = 'CarQueue' width="100%" border="0">  <tr>
											<td class='w-130'>限速：</td>
											<td ><input name="Vlan_CuridxValue_down" type="text" id="Vlan_CuridxValue_down" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
										...
										<div id="VlanAdd_down" style="display:none">
											...
											<tr>
											<td class='w-130'>限速：</td>
											<td ><input name="Vlan_CuridxValue1_down" type="text" id="Vlan_CuridxValue1_down" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
											...
											<tr>
											<td class='w-130'>IP范围：</td>
											<td class='w-50'><input name="Ip_Start_down" type="text" id="Ip_Start_down" value="0" size="15" maxlength="15">
											</td>
											<td class='w-5' style="text-align:center">-
											</td>
											<td class='w-50'><input name="Ip_End_down" type="text" id="Ip_End_down" value="0" size="15" maxlength="15">
											</td>
											</tr>
											</table>
											<table id = 'CarQueue' width="100%" border="0">  
											<tr>
											<td width=130>限速：</td>
											<td ><input name="Ip_CuridxValue_down" type="text" id="Ip_CuridxValue_down" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
										...
										<div id="IpAdd_down" style="display:none">
											...
											<tr>
											<td class='w-130'>IP范围：</td>
											<td class='w-50'><input name="Ip_Start1_down" type="text" id="Ip_Start1_down" value="0" size="10" maxlength="15">
											</td>
											<td class='w-5' style="text-align:center">-
											</td>
											<td class='w-50'><input name="Ip_End1_down" type="text" id="Ip_End1_down" value="0" size="15" maxlength="15">
											</td>
											<td></td>
											</tr>
											</table>
											...
											<tr>
											<td class='w-130'>限速：</td>
											<td ><input name="Ip_CuridxValue1_down" type="text" id="Ip_CuridxValue1_down" value="0" size="10" maxlength="10"> </td>
											</tr>
											</table>
											<table width="100%" border="0">
											<tr>
