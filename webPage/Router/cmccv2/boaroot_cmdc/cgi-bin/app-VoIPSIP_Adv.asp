...
if request_Form("VoIP8021pEnableFlag") = "1" then
	...
	tcWebApi_set("VoIPCallCtrl_Entry0", "SyncCallerTimeEnable", "synphonedate0")
	If tcWebApi_get("VoIPBasic_Common","VoIPLine2Enable","h") = "Yes" then
	...
	tcWebApi_set("VoIPCallCtrl_Entry1", "SyncCallerTimeEnable", "synphonedate1")	
	End If
...
function generatePerLineTable() {
   ...
   if (document.body.innerHTML) {
      var tableHtmlOutput = "<table id='perLineTable1' border='1' class='tblTransList2'><tbody id='perLineTbody1'>";
      ...
      // Codec rows
		  tableHtmlOutput += "<tr class='hide'><td >G.722<\/td>"
		  ...
		  tableHtmlOutput += "<tr class='hide'><td >G.711ALaw<\/td>"
		  ...
		  tableHtmlOutput += "<tr class='hide'><td >G.711ULaw<\/td>"
		  ...
		  tableHtmlOutput += "<tr class='hide'><td >G.729<\/td>"
      ...
      tableHtmlOutput += "<table id='perLineTable2' border='1' class='tblTransList2'><tbody id='perLineTbody2'>";
      ...
      tableHtmlOutput += "<table id='perLineTable3' border='1' class='tblTransList2'><tbody id='perLineTbody3'>";
      ...
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >三方会议资源接入码<\/td>"
    ...
    //caller id mode
      ...
      //subscribe type
      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >订阅类型 <\/td>"
      var selectOptions0 = Array();
      selectOptions0[0] = "<option value=" + 0 + " <%if tcWebApi_get("VoIPAdvanced_Entry0", "SubscribeType", "h") = "0" then asp_Write("selected") end if %>>" + "不订阅";
      selectOptions0[1] = "<option value=" + 1 + " <%if tcWebApi_get("VoIPAdvanced_Entry0", "SubscribeType", "h") = "1" then asp_Write("selected") end if %>>" + "订阅业务";   
      selectOptions0[2] = "<option value=" + 2 + " <%if tcWebApi_get("VoIPAdvanced_Entry0", "SubscribeType", "h") = "2" then asp_Write("selected") end if %>>" + "订阅注册";
      selectOptions0[3] = "<option value=" + 3 + " <%if tcWebApi_get("VoIPAdvanced_Entry0", "SubscribeType", "h") = "3" then asp_Write("selected") end if %>>" + "订阅全部";   
      tableHtmlOutput += "<td align=center><select name='DivSubscribeType0'>" + selectOptions0.join("") + "<\/select></td>";
                  
      <% if tcwebApi_get("VoIPBasic_Common","VoIPLine2Enable","h") = "Yes" then %>       
      var selectOptions1 = Array();
      selectOptions1[0] = "<option value=" + 0 + " <%if tcWebApi_get("VoIPAdvanced_Entry1", "SubscribeType", "h") = "0" then asp_Write("selected") end if %>>" + "不订阅";
      selectOptions1[1] = "<option value=" + 1 + " <%if tcWebApi_get("VoIPAdvanced_Entry1", "SubscribeType", "h") = "1" then asp_Write("selected") end if %>>" + "订阅业务";   
      selectOptions1[2] = "<option value=" + 2 + " <%if tcWebApi_get("VoIPAdvanced_Entry1", "SubscribeType", "h") = "2" then asp_Write("selected") end if %>>" + "订阅注册";
      selectOptions1[3] = "<option value=" + 3 + " <%if tcWebApi_get("VoIPAdvanced_Entry1", "SubscribeType", "h") = "3" then asp_Write("selected") end if %>>" + "订阅全部";   
      tableHtmlOutput += "<td align=center><select name='DivSubscribeType1'>" + selectOptions1.join("") + "<\/select></td>";
      <% end if %>
      tableHtmlOutput += "</tr>";

      tableHtmlOutput += "<tr>";
      tableHtmlOutput += "<td >订阅周期(秒)<\/td>"
	...
	//Synchronize phone date time
      ...
      var selectSynPhoneDate0 = Array();
      selectSynPhoneDate0[0] = "<option value=0 <%if tcWebApi_get("VoIPCallCtrl_Entry0", "SyncCallerTimeEnable", "h") = "0" then  asp_Write("selected") end if %>>" + "强制不带时间";
      selectSynPhoneDate0[1] = "<option value=1 <%if tcWebApi_get("VoIPCallCtrl_Entry0", "SyncCallerTimeEnable", "h") = "1" then  asp_Write("selected") end if %>>" + "强制带时间";
      selectSynPhoneDate0[2] = "<option value=2 <%if tcWebApi_get("VoIPCallCtrl_Entry0", "SyncCallerTimeEnable", "h") = "2" then  asp_Write("selected") end if %>>" + "自动";
      tableHtmlOutput += "<td align=center><select name='synphonedate0'>" + selectSynPhoneDate0.join("") + "<\/select></td>";
      
      <% if tcwebApi_get("VoIPBasic_Common","VoIPLine2Enable","h") = "Yes" then %>
      var selectSynPhoneDate1 = Array();
      selectSynPhoneDate1[0] = "<option value=0 <%if tcWebApi_get("VoIPCallCtrl_Entry1", "SyncCallerTimeEnable", "h") = "0" then  asp_Write("selected") end if %>>" + "强制不带时间";
      selectSynPhoneDate1[1] = "<option value=1 <%if tcWebApi_get("VoIPCallCtrl_Entry1", "SyncCallerTimeEnable", "h") = "1" then  asp_Write("selected") end if %>>" + "强制带时间";
      selectSynPhoneDate1[2] = "<option value=2 <%if tcWebApi_get("VoIPCallCtrl_Entry1", "SyncCallerTimeEnable", "h") = "2" then  asp_Write("selected") end if %>>" + "自动";
      tableHtmlOutput += "<td align=center><select name='synphonedate1'>" + selectSynPhoneDate1.join("") + "<\/select></td>";
      <% end if %>
      tableHtmlOutput += "</tr>";
      ...
      tableHtmlOutput += "<table id='Table_DigitMap' border='1' class='tblTransList2'><tbody id='Tbody_DigitMap'>";

      tableHtmlOutput += "<tr class='hide'>";
      ...
      tableHtmlOutput += "<tr class='hide' id='sec_DigitMap'>";
      tableHtmlOutput += "<td align=center colSpan=2><textarea id=\'txt_DigitMap\' name=\'txt_DigitMap\' rows=4 maxlength=4096 wrap='OFF' style='WIDTH:90%;'></textarea></td>";
      tableHtmlOutput += "</tr>"; 
...
<%end if%>
	...
	<%end if%>
    {
	  ...
	  var temp = parseInt(ingressGain1.value);	
		...
		if (temp < 1 || temp > 1000)
		{
			alert('jitter buffer 最大值的范围是1~1000.');
			return;
		}
									               ...
									               <% end if %>
									                  ...
									                  <td>
									                  	<select name="optionssericemode" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "OptionsSericeMode", "h") = "0" then asp_Write("selected") end if %>>注册服务器模式</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "OptionsSericeMode", "h") = "1" then asp_Write("selected") end if %>>代理服务器模式</option>
											   	                <option value="2" <%if tcWebApi_get("VoIPAdvanced_Common", "OptionsSericeMode", "h") = "2" then asp_Write("selected") end if %>>Outbound模式</option>
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
									               ...
									               <tr >
									                  ...
									                  <td>
									                  	<select name="EndCharacterHandleMode" size="1">
											   	                <option value="0" <%if tcWebApi_get("VoIPAdvanced_Common", "EndCharHandleMode", "h") = "0" then asp_Write("selected") end if %>>终止模式</option>
											   	                <option value="1" <%if tcWebApi_get("VoIPAdvanced_Common", "EndCharHandleMode", "h") = "1" then asp_Write("selected") end if %>>规则模式</option>											   	                
											   	            </select>
									                  </td>
									               </tr>
									               <tr >
